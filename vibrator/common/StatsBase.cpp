...
using VibratorPlaycountReported =
        ::android::hardware::google::pixel::vendor::PixelAtoms::VibratorPlaycountReported;
using VibratorLatencyReported =
        ::android::hardware::google::pixel::vendor::PixelAtoms::VibratorLatencyReported;
using VibratorErrorsReported =
        ::android::hardware::google::pixel::vendor::PixelAtoms::VibratorErrorsReported;
